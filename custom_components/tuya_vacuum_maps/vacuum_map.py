...
from custom_components.tuya_vacuum_maps.vacuum_map_layout import VacuumMapLayout
from custom_components.tuya_vacuum_maps.vacuum_map_path import VacuumMapPath, PATH_SCALE
